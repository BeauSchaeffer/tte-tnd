...
rsync -avh --progress \
  bschaeffer@login.rc.fas.harvard.edu:/n/holylfs05/LABS/hanage_lab/Lab/hsphfs1/bschaeffer/kaiser/plots_pp.2/ \
  /Users/beauschaeffer/Desktop/Research/tte-tnd/plots_pp.2/
