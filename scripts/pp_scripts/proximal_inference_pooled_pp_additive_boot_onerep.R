...
##----- Proximal Inference Pooled ADDITIVE PP Bootstrap
...
##----- Mirrors proximal_inference_pooled_pp_boot_onerep.R but with additive
##----- (identity-link) hazard models and the additive g-computation.
...
res_path <- "/n/holylfs05/LABS/hanage_lab/Lab/hsphfs1/bschaeffer/kaiser/results_pp.3/pci_add_boot_reps"
...
t0 <- Sys.time()
message("Starting PCI PP additive bootstrap ", i, " (seed=", seed[i], ")")
...
saveRDS(out, sprintf("%s/pci_add_pp_boot_rep_%03d.rds", res_path, i))
