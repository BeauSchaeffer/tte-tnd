...
# STD Pooled
std.pp.risks.ci <- readRDS(paste0(res_path, "std.pp.risks.ci.rds"))

# TND
tnd.pp.pointest <- readRDS(paste0(res_path,"tnd.pp.pointest.rds"))

# EQC Cox
eqc.pp.HRs.ci <- readRDS(paste0(res_path, "eqc.pp.HRs.ci.rds"))

# EQC Pooled
eqc.pp.risks.ci <- readRDS(paste0(res_path, "eqc.pp.risks.ci.rds"))

# PCI Cox
pci.pp.HRs.ci <- readRDS(paste0(res_path, "pci.pp.HRs.ci.rds"))
